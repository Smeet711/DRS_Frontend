        ...
        <div className="container">
          ...
          <form action="" className="hero-form">
            ...
            <div className="input-wrapper">
              <label for="input-1" className="input-label">Source</label>
            ...
            <div className="input-wrapper">
              <label for="input-2" className="input-label">Destination</label>

              <input type="text" name="monthly-pay" id="input-2" className="input-field" placeholder="To Where?"/>
            </div>

            <div className="input-wrapper">
              <label for="input-3" className="input-label">When</label>
