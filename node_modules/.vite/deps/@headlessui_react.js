...
function D({ ourProps: r11, theirProps: t14, slot: e6, defaultTag: a11, features: s17, visible: n5 = true, name: l11 }) {
  ...
  if (f12 & 2) {
    let _a = o11, { static: i10 = false } = _a, u8 = __objRest(_a, ["static"]);
    if (i10)
      return m3(u8, e6, a11, l11);
  }
  if (f12 & 1) {
    let _b = o11, { unmount: i10 = true } = _b, u8 = __objRest(_b, ["unmount"]);
    return u(i10 ? 0 : 1, { [0]() {
      return null;
    }, [1]() {
      return m3(__spreadProps(__spreadValues({}, u8), { hidden: true, style: { display: "none" } }), e6, a11, l11);
    } });
  }
  return m3(o11, e6, a11, l11);
}
function m3(r11, t14 = {}, e6, a11) {
  var y5;
  let _a = g2(r11, ["unmount", "static"]), { as: s17 = e6, children: n5, refName: l11 = "ref" } = _a, o11 = __objRest(_a, ["as", "children", "refName"]), f12 = r11.ref !== void 0 ? { [l11]: r11.ref } : {}, i10 = typeof n5 == "function" ? n5(t14) : n5;
...
function s8(t14, o11) {
  let _a = t14, { features: n5 = 1 } = _a, e6 = __objRest(_a, ["features"]), d15 = { ref: o11, "aria-hidden": (n5 & 2) === 2 ? true : void 0, style: __spreadValues({ position: "fixed", top: 1, left: 1, width: 1, height: 0, padding: 0, margin: -1, overflow: "hidden", clip: "rect(0, 0, 0, 0)", whiteSpace: "nowrap", borderWidth: "0" }, (n5 & 4) === 4 && (n5 & 2) !== 2 && { display: "none" }) };
...
var He = { [1](t14) {
  var l11;
  return (l11 = t14.dataRef.current) != null && l11.disabled || t14.comboboxState === 1 ? t14 : __spreadProps(__spreadValues({}, t14), { activeOptionIndex: null, comboboxState: 1 });
}, [0](t14) {
  var e6;
  ...
  return __spreadProps(__spreadValues({}, t14), { comboboxState: 0, activeOptionIndex: l11 });
}, [2](t14, l11) {
  var i10, s17, n5, d15;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, t14), e6), { activeOptionIndex: r11, activationTrigger: (d15 = l11.trigger) != null ? d15 : 1 });
}, [3]: (t14, l11) => {
  var s17, n5;
  ...
  let i10 = __spreadProps(__spreadValues(__spreadValues({}, t14), r11), { activationTrigger: 1 });
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, t14), e6), { activationTrigger: 1 });
}, [5]: (t14, l11) => __spreadProps(__spreadValues({}, t14), { labelId: l11.id }) };
...
function Xe(t14, l11) {
  let _a = t14, { value: e6, defaultValue: r11, onChange: i10, name: s17, by: n5 = (p9, T7) => p9 === T7, disabled: d15 = false, __demoMode: o11 = false, nullable: u8 = false, multiple: P7 = false } = _a, f12 = __objRest(_a, ["value", "defaultValue", "onChange", "name", "by", "disabled", "__demoMode", "nullable", "multiple"]), [O3 = P7 ? [] : void 0, m11] = T4(e6, i10, r11), [g6, c10] = (0, import_react18.useReducer)(Ne, { dataRef: (0, import_react18.createRef)(), comboboxState: o11 ? 0 : 1, options: [], activeOptionIndex: null, activationTrigger: 1, labelId: null }), C4 = (0, import_react18.useRef)(false), N5 = (0, import_react18.useRef)({ static: false, hold: false }), F9 = (0, import_react18.useRef)(null), _4 = (0, import_react18.useRef)(null), h10 = (0, import_react18.useRef)(null), B4 = (0, import_react18.useRef)(null), V7 = o4(typeof n5 == "string" ? (p9, T7) => {
    let v5 = n5;
    return (p9 == null ? void 0 : p9[v5]) === (T7 == null ? void 0 : T7[v5]);
  } : n5), G3 = (0, import_react18.useCallback)((p9) => u(b6.mode, { [1]: () => O3.some((T7) => V7(T7, p9)), [0]: () => V7(O3, p9) }), [O3]), b6 = (0, import_react18.useMemo)(() => __spreadProps(__spreadValues({}, g6), { optionsPropsRef: N5, labelRef: F9, inputRef: _4, buttonRef: h10, optionsRef: B4, value: O3, defaultValue: r11, disabled: d15, mode: P7 ? 1 : 0, get activeOptionIndex() {
...
function Je(t14, l11) {
  var G3, b6, L7, y5;
  let e6 = I(), _a = t14, { id: r11 = `headlessui-combobox-input-${e6}`, onChange: i10, displayValue: s17, type: n5 = "text" } = _a, d15 = __objRest(_a, ["id", "onChange", "displayValue", "type"]), o11 = H2("Combobox.Input"), u8 = $("Combobox.Input"), P7 = y(o11.inputRef, l11), f12 = (0, import_react18.useRef)(false), O3 = p(), m11 = function() {
    var a11;
...
function We(t14, l11) {
  var g6;
  let e6 = H2("Combobox.Button"), r11 = $("Combobox.Button"), i10 = y(e6.buttonRef, l11), s17 = I(), _a = t14, { id: n5 = `headlessui-combobox-button-${s17}` } = _a, d15 = __objRest(_a, ["id"]), o11 = p(), u8 = o4((c10) => {
    switch (c10.key) {
      case o8.ArrowDown:
...
var $e = "label";
function qe(t14, l11) {
  let e6 = I(), _a = t14, { id: r11 = `headlessui-combobox-label-${e6}` } = _a, i10 = __objRest(_a, ["id"]), s17 = H2("Combobox.Label"), n5 = $("Combobox.Label"), d15 = y(s17.labelRef, l11);
...
function Ze(t14, l11) {
  let e6 = I(), _a = t14, { id: r11 = `headlessui-combobox-options-${e6}`, hold: i10 = false } = _a, s17 = __objRest(_a, ["id", "hold"]), n5 = H2("Combobox.Options"), d15 = y(n5.optionsRef, l11), o11 = C(), u8 = (() => o11 !== null ? (o11 & d4.Open) === d4.Open : n5.comboboxState === 0)();
  l(() => {
    var m11;
...
function eo(t14, l11) {
  var b6, L7;
  let e6 = I(), _a = t14, { id: r11 = `headlessui-combobox-option-${e6}`, disabled: i10 = false, value: s17 } = _a, n5 = __objRest(_a, ["id", "disabled", "value"]), d15 = H2("Combobox.Option"), o11 = $("Combobox.Option"), u8 = d15.activeOptionIndex !== null ? d15.options[d15.activeOptionIndex].id === r11 : false, P7 = d15.isSelected(s17), f12 = (0, import_react18.useRef)(null), O3 = s2({ disabled: i10, value: s17, domRef: f12, textValue: (L7 = (b6 = f12.current) == null ? void 0 : b6.textContent) == null ? void 0 : L7.toLowerCase() }), m11 = y(l11, f12), g6 = o4(() => o11.selectOption(r11));
...
function X(t14, n5) {
  let e6 = (0, import_react24.useRef)(null), o11 = y(e6, n5), _a = t14, { initialFocus: u8, containers: i10, features: r11 = 30 } = _a, l11 = __objRest(_a, ["initialFocus", "containers", "features"]);
  l2() || (r11 = 1);
  let m11 = n4(e6);
...
function U2(u8, a11) {
  let _a = u8, { target: o11 } = _a, e6 = __objRest(_a, ["target"]), n5 = { ref: y(a11) };
...
var S4 = "p";
function h4(r11, t14) {
  let a11 = I(), _a = r11, { id: e6 = `headlessui-description-${a11}` } = _a, i10 = __objRest(_a, ["id"]), n5 = f7(), s17 = y(t14);
  l(() => n5.register(e6), [e6, n5.register]);
  let o11 = __spreadProps(__spreadValues({ ref: s17 }, n5.props), { id: e6 });
...
var ke2 = { [0](t14, e6) {
  return t14.titleId === e6.id ? t14 : __spreadProps(__spreadValues({}, t14), { titleId: e6.id });
} };
...
function Ie(t14, e6) {
  let o11 = I(), _a = t14, { id: s17 = `headlessui-dialog-${o11}`, open: n5, onClose: l11, initialFocus: d15, __demoMode: c10 = false } = _a, D8 = __objRest(_a, ["id", "open", "onClose", "initialFocus", "__demoMode"]), [P7, F9] = (0, import_react29.useState)(0), i10 = C();
...
var we2 = "div";
function Be2(t14, e6) {
  let o11 = I(), _a = t14, { id: s17 = `headlessui-dialog-overlay-${o11}` } = _a, n5 = __objRest(_a, ["id"]), [{ dialogState: l11, close: d15 }] = S6("Dialog.Overlay"), c10 = y(e6), D8 = o4((i10) => {
...
var Ge2 = "div";
function Ue2(t14, e6) {
  let o11 = I(), _a = t14, { id: s17 = `headlessui-dialog-backdrop-${o11}` } = _a, n5 = __objRest(_a, ["id"]), [{ dialogState: l11 }, d15] = S6("Dialog.Backdrop"), c10 = y(e6);
...
var Ne2 = "div";
function Ye2(t14, e6) {
  let o11 = I(), _a = t14, { id: s17 = `headlessui-dialog-panel-${o11}` } = _a, n5 = __objRest(_a, ["id"]), [{ dialogState: l11 }, d15] = S6("Dialog.Panel"), c10 = y(e6, d15.panelRef), D8 = (0, import_react29.useMemo)(() => ({ open: l11 === 0 }), [l11]), P7 = o4((i10) => {
    i10.stopPropagation();
  });
...
var $e2 = "h2";
function We2(t14, e6) {
  let o11 = I(), _a = t14, { id: s17 = `headlessui-dialog-title-${o11}` } = _a, n5 = __objRest(_a, ["id"]), [{ dialogState: l11, setTitleId: d15 }] = S6("Dialog.Title"), c10 = y(e6);
...
var Q2 = { [0]: (e6) => __spreadProps(__spreadValues({}, e6), { disclosureState: u(e6.disclosureState, { [0]: 1, [1]: 0 }) }), [1]: (e6) => e6.disclosureState === 1 ? e6 : __spreadProps(__spreadValues({}, e6), { disclosureState: 1 }), [4](e6) {
  return e6.linkedPanel === true ? e6 : __spreadProps(__spreadValues({}, e6), { linkedPanel: true });
}, [5](e6) {
  return e6.linkedPanel === false ? e6 : __spreadProps(__spreadValues({}, e6), { linkedPanel: false });
}, [2](e6, n5) {
  return e6.buttonId === n5.buttonId ? e6 : __spreadProps(__spreadValues({}, e6), { buttonId: n5.buttonId });
}, [3](e6, n5) {
  return e6.panelId === n5.panelId ? e6 : __spreadProps(__spreadValues({}, e6), { panelId: n5.panelId });
} };
...
function ee(e6, n5) {
  let _a = e6, { defaultOpen: o11 = false } = _a, u8 = __objRest(_a, ["defaultOpen"]), T7 = (0, import_react31.useRef)(null), l11 = y(n5, T2((a11) => {
    T7.current = a11;
...
var te2 = "button";
function ne(e6, n5) {
  let o11 = I(), _a = e6, { id: u8 = `headlessui-disclosure-button-${o11}` } = _a, T7 = __objRest(_a, ["id"]), [l11, t14] = M4("Disclosure.Button"), f12 = V(), s17 = f12 === null ? false : f12 === l11.panelId, i10 = (0, import_react31.useRef)(null), c10 = y(i10, n5, s17 ? null : l11.buttonRef);
...
function re2(e6, n5) {
  let o11 = I(), _a = e6, { id: u8 = `headlessui-disclosure-panel-${o11}` } = _a, T7 = __objRest(_a, ["id"]), [l11, t14] = M4("Disclosure.Panel"), { close: f12 } = w3("Disclosure.Panel"), s17 = y(n5, l11.panelRef, (P7) => {
    a9(() => t14({ type: P7 ? 4 : 5 }));
  });
...
var Ge3 = { [1](e6) {
  return e6.dataRef.current.disabled || e6.listboxState === 1 ? e6 : __spreadProps(__spreadValues({}, e6), { activeOptionIndex: null, listboxState: 1 });
}, [0](e6) {
  ...
  return n5 !== -1 && (r11 = n5), __spreadProps(__spreadValues({}, e6), { listboxState: 0, activeOptionIndex: r11 });
}, [2](e6, r11) {
  var a11;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, e6), o11), { searchQuery: "", activeOptionIndex: n5, activationTrigger: (a11 = r11.trigger) != null ? a11 : 1 });
}, [3]: (e6, r11) => {
  if (e6.dataRef.current.disabled || e6.listboxState === 1)
    return e6;
  ...
  return c10 === -1 || c10 === e6.activeOptionIndex ? __spreadProps(__spreadValues({}, e6), { searchQuery: a11 }) : __spreadProps(__spreadValues({}, e6), { searchQuery: a11, activeOptionIndex: c10, activationTrigger: 1 });
}, [4](e6) {
  return e6.dataRef.current.disabled || e6.listboxState === 1 || e6.searchQuery === "" ? e6 : __spreadProps(__spreadValues({}, e6), { searchQuery: "" });
}, [5]: (e6, r11) => {
  let o11 = { id: r11.id, dataRef: r11.dataRef }, n5 = $2(e6, (a11) => [...a11, o11]);
  return e6.activeOptionIndex === null && e6.dataRef.current.isSelected(r11.dataRef.current.value) && (n5.activeOptionIndex = n5.options.indexOf(o11)), __spreadValues(__spreadValues({}, e6), n5);
}, [6]: (e6, r11) => {
  let o11 = $2(e6, (n5) => {
    let a11 = n5.findIndex((t14) => t14.id === r11.id);
    return a11 !== -1 && n5.splice(a11, 1), n5;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, e6), o11), { activationTrigger: 1 });
}, [7]: (e6, r11) => __spreadProps(__spreadValues({}, e6), { labelId: r11.id }) };
...
function Ve2(e6, r11) {
  let _a = e6, { value: o11, defaultValue: n5, name: a11, onChange: t14, by: u8 = (s17, f12) => s17 === f12, disabled: c10 = false, horizontal: i10 = false, multiple: b6 = false } = _a, A6 = __objRest(_a, ["value", "defaultValue", "name", "onChange", "by", "disabled", "horizontal", "multiple"]);
  ...
  } : u8), L7 = (0, import_react32.useCallback)((s17) => u(d15.mode, { [1]: () => g6.some((f12) => C4(f12, s17)), [0]: () => C4(g6, s17) }), [g6]), d15 = (0, import_react32.useMemo)(() => __spreadProps(__spreadValues({}, S9), { value: g6, disabled: c10, mode: b6 ? 1 : 0, orientation: m11, compare: C4, isSelected: L7, optionsPropsRef: l11, labelRef: x6, buttonRef: E7, optionsRef: W }), [g6, c10, b6, S9]);
  l(() => {
  ...
  }, [G3, F9]), import_react32.default.createElement(z4.Provider, { value: ce4 }, import_react32.default.createElement(J2.Provider, { value: d15 }, import_react32.default.createElement(c3, { value: u(d15.listboxState, { [0]: d4.Open, [1]: d4.Closed }) }, a11 != null && g6 != null && e3({ [a11]: g6 }).map(([s17, f12], O3) => import_react32.default.createElement(c2, __spreadValues({ features: p3.Hidden, ref: O3 === 0 ? (M8) => {
    var q6;
...
function Qe2(e6, r11) {
  var S9;
  let o11 = I(), _a = e6, { id: n5 = `headlessui-listbox-button-${o11}` } = _a, a11 = __objRest(_a, ["id"]), t14 = B("Listbox.Button"), u8 = U3("Listbox.Button"), c10 = y(t14.buttonRef, r11), i10 = p(), b6 = o4((p9) => {
    switch (p9.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
...
var We3 = "label";
function Xe3(e6, r11) {
  let o11 = I(), _a = e6, { id: n5 = `headlessui-listbox-label-${o11}` } = _a, a11 = __objRest(_a, ["id"]), t14 = B("Listbox.Label"), u8 = U3("Listbox.Label"), c10 = y(t14.labelRef, r11);
...
function Je3(e6, r11) {
  var p9;
  let o11 = I(), _a = e6, { id: n5 = `headlessui-listbox-options-${o11}` } = _a, a11 = __objRest(_a, ["id"]), t14 = B("Listbox.Options"), u8 = U3("Listbox.Options"), c10 = y(t14.optionsRef, r11), i10 = p(), b6 = p(), A6 = C(), m11 = (() => A6 !== null ? (A6 & d4.Open) === d4.Open : t14.listboxState === 0)();
...
var de = { [1](e6) {
  return e6.menuState === 1 ? e6 : __spreadProps(__spreadValues({}, e6), { activeItemIndex: null, menuState: 1 });
}, [0](e6) {
  return e6.menuState === 0 ? e6 : __spreadProps(__spreadValues({}, e6), { menuState: 0 });
}, [2]: (e6, u8) => {
  var s17;
  ...
  return __spreadProps(__spreadValues(__spreadValues({}, e6), r11), { searchQuery: "", activeItemIndex: i10, activationTrigger: (s17 = u8.trigger) != null ? s17 : 1 });
}, [3]: (e6, u8) => {
  ...
  return a11 === -1 || a11 === e6.activeItemIndex ? __spreadProps(__spreadValues({}, e6), { searchQuery: s17 }) : __spreadProps(__spreadValues({}, e6), { searchQuery: s17, activeItemIndex: a11, activationTrigger: 1 });
}, [4](e6) {
  return e6.searchQuery === "" ? e6 : __spreadProps(__spreadValues({}, e6), { searchQuery: "", searchActiveItemIndex: null });
}, [5]: (e6, u8) => {
  let r11 = w4(e6, (i10) => [...i10, { id: u8.id, dataRef: u8.dataRef }]);
  return __spreadValues(__spreadValues({}, e6), r11);
}, [6]: (e6, u8) => {
  let r11 = w4(e6, (i10) => {
    let s17 = i10.findIndex((t14) => t14.id === u8.id);
    return s17 !== -1 && i10.splice(s17, 1), i10;
  });
  return __spreadProps(__spreadValues(__spreadValues({}, e6), r11), { activationTrigger: 1 });
} };
...
function Me2(e6, u8) {
  var I7;
  let r11 = I(), _a = e6, { id: i10 = `headlessui-menu-button-${r11}` } = _a, s17 = __objRest(_a, ["id"]), [t14, o11] = F5("Menu.Button"), a11 = y(t14.buttonRef, u8), l11 = p(), m11 = o4((p9) => {
    switch (p9.key) {
      case o8.Space:
      case o8.Enter:
      case o8.ArrowDown:
...
function Ae(e6, u8) {
  var R3, E7;
  let r11 = I(), _a = e6, { id: i10 = `headlessui-menu-items-${r11}` } = _a, s17 = __objRest(_a, ["id"]), [t14, o11] = F5("Menu.Items"), a11 = y(t14.itemsRef, u8), l11 = n4(t14.itemsRef), m11 = p(), M8 = C(), f12 = (() => M8 !== null ? (M8 & d4.Open) === d4.Open : t14.menuState === 0)();
...
function Ee(e6, u8) {
  let r11 = I(), _a = e6, { id: i10 = `headlessui-menu-item-${r11}`, disabled: s17 = false } = _a, t14 = __objRest(_a, ["id", "disabled"]), [o11, a11] = F5("Menu.Item"), l11 = o11.activeItemIndex !== null ? o11.items[o11.activeItemIndex].id === i10 : false, m11 = (0, import_react33.useRef)(null), M8 = y(u8, m11);
  l(() => {
...
var xe5 = { [0]: (o11) => __spreadProps(__spreadValues({}, o11), { popoverState: u(o11.popoverState, { [0]: 1, [1]: 0 }) }), [1](o11) {
  return o11.popoverState === 1 ? o11 : __spreadProps(__spreadValues({}, o11), { popoverState: 1 });
}, [2](o11, l11) {
  return o11.button === l11.button ? o11 : __spreadProps(__spreadValues({}, o11), { button: l11.button });
}, [3](o11, l11) {
  return o11.buttonId === l11.buttonId ? o11 : __spreadProps(__spreadValues({}, o11), { buttonId: l11.buttonId });
}, [4](o11, l11) {
  return o11.panel === l11.panel ? o11 : __spreadProps(__spreadValues({}, o11), { panel: l11.panel });
}, [5](o11, l11) {
  return o11.panelId === l11.panelId ? o11 : __spreadProps(__spreadValues({}, o11), { panelId: l11.panelId });
} };
...
function He4(o11, l11) {
  let s17 = I(), _a = o11, { id: R3 = `headlessui-popover-button-${s17}` } = _a, C4 = __objRest(_a, ["id"]), [r11, t14] = Q3("Popover.Button"), { isPortalled: a11 } = pe3("Popover.Button"), v5 = (0, import_react34.useRef)(null), f12 = `headlessui-focus-sentinel-${I()}`, F9 = ve3(), T7 = F9 == null ? void 0 : F9.closeOthers, i10 = Le() !== null;
...
function ke3(o11, l11) {
  let s17 = I(), _a = o11, { id: R3 = `headlessui-popover-overlay-${s17}` } = _a, C4 = __objRest(_a, ["id"]), [{ popoverState: r11 }, t14] = Q3("Popover.Overlay"), a11 = y(l11), v5 = C(), f12 = (() => v5 !== null ? (v5 & d4.Open) === d4.Open : r11 === 0)(), F9 = o4((i10) => {
    if (r3(i10.currentTarget))
      return i10.preventDefault();
    t14({ type: 1 });
...
function Ue4(o11, l11) {
  let s17 = I(), _a = o11, { id: R3 = `headlessui-popover-panel-${s17}`, focus: C4 = false } = _a, r11 = __objRest(_a, ["id", "focus"]), [t14, a11] = Q3("Popover.Panel"), { close: v5, isPortalled: f12 } = pe3("Popover.Panel"), F9 = `headlessui-focus-sentinel-before-${I()}`, T7 = `headlessui-focus-sentinel-after-${I()}`, d15 = (0, import_react34.useRef)(null), i10 = y(d15, l11, (u8) => {
    a11({ type: 4, panel: u8 });
  }), p9 = n4(d15);
...
var A3 = "label";
function h9(o11, t14) {
  let i10 = I(), _a = o11, { id: e6 = `headlessui-label-${i10}`, passive: s17 = false } = _a, a11 = __objRest(_a, ["id", "passive"]), r11 = u7(), l11 = y(t14);
  l(() => r11.register(e6), [e6, r11.register]);
  let n5 = __spreadProps(__spreadValues({ ref: l11 }, r11.props), { id: e6 });
...
var Ce2 = { [0](r11, o11) {
  ...
  return __spreadProps(__spreadValues({}, r11), { options: A(t14, (a11) => a11.element.current) });
}, [1](r11, o11) {
  let t14 = r11.options.slice(), a11 = r11.options.findIndex((f12) => f12.id === o11.id);
  return a11 === -1 ? r11 : (t14.splice(a11, 1), __spreadProps(__spreadValues({}, r11), { options: t14 }));
} };
...
function he2(r11, o11) {
  let t14 = I(), _a = r11, { id: a11 = `headlessui-radiogroup-${t14}`, value: f12, defaultValue: E7, name: _4, onChange: v5, by: D8 = (e6, i10) => e6 === i10, disabled: G3 = false } = _a, H8 = __objRest(_a, ["id", "value", "defaultValue", "name", "onChange", "by", "disabled"]), T7 = o4(typeof D8 == "string" ? (e6, i10) => {
    let n5 = D8;
  ...
  }), x6 = o4((e6) => (k3(__spreadValues({ type: 0 }, e6)), () => k3({ type: 1, id: e6.id }))), R3 = (0, import_react37.useMemo)(() => __spreadValues({ value: l11, firstOption: u8, containsCheckedOption: y5, disabled: G3, compare: T7 }, C4), [l11, u8, y5, G3, T7, C4]), I7 = (0, import_react37.useMemo)(() => ({ registerOption: x6, change: d15 }), [x6, d15]), ie4 = { ref: N5, id: a11, role: "radiogroup", "aria-labelledby": w6, "aria-describedby": m11, onKeyDown: W }, ae3 = (0, import_react37.useMemo)(() => ({ value: l11 }), [l11]), S9 = (0, import_react37.useRef)(null), pe4 = p();
  return (0, import_react37.useEffect)(() => {
    S9.current && E7 !== void 0 && pe4.addEventListener(S9.current, "reset", () => {
      d15(E7);
    });
  }, [S9, d15]), import_react37.default.createElement(L7, { name: "RadioGroup.Description" }, import_react37.default.createElement(U5, { name: "RadioGroup.Label" }, import_react37.default.createElement($4.Provider, { value: I7 }, import_react37.default.createElement(B3.Provider, { value: R3 }, _4 != null && l11 != null && e3({ [_4]: l11 }).map(([e6, i10], n5) => import_react37.default.createElement(c2, __spreadValues({ features: p3.Hidden, ref: n5 === 0 ? (c10) => {
    var s17;
...
function _e4(r11, o11) {
  var x6;
  let t14 = I(), _a = r11, { id: a11 = `headlessui-radiogroup-option-${t14}`, value: f12, disabled: E7 = false } = _a, _4 = __objRest(_a, ["id", "value", "disabled"]), v5 = (0, import_react37.useRef)(null), D8 = y(v5, o11), [G3, H8] = H6(), [T7, C4] = M(), { addFlag: k3, removeFlag: p9, hasFlag: w6 } = b3(1), U5 = s2({ value: f12, disabled: E7 }), m11 = oe2("RadioGroup.Option"), L7 = ne2("RadioGroup.Option");
...
var Z5 = "button";
function ee3(p9, n5) {
  let c10 = I(), _a = p9, { id: d15 = `headlessui-switch-${c10}`, checked: m11, defaultChecked: r11 = false, onChange: f12, name: a11, value: h10 } = _a, T7 = __objRest(_a, ["id", "checked", "defaultChecked", "onChange", "name", "value"]), t14 = (0, import_react38.useContext)(b5), o11 = (0, import_react38.useRef)(null), D8 = y(o11, n5, t14 === null ? null : t14.setSwitch), [i10, s17] = T4(m11, f12, r11), y5 = o4(() => s17 == null ? void 0 : s17(!i10)), g6 = o4((e6) => {
  ...
  }, [o11, s17]), import_react38.default.createElement(import_react38.default.Fragment, null, a11 != null && i10 && import_react38.default.createElement(c2, __spreadValues({ features: p3.Hidden }, P({ as: "input", type: "checkbox", hidden: true, readOnly: true, checked: i10, name: a11, value: h10 }))), D({ ourProps: G3, theirProps: T7, slot: v5, defaultTag: Z5, name: "Switch" }));
}
var te3 = L3(ee3);
var ne3 = Y5;
...
var ce3 = { [0](e6, n5) {
  ...
  }), r11 = __spreadProps(__spreadValues({}, e6), { tabs: t14, panels: o11 });
  if (n5.index < 0 || n5.index > t14.length - 1) {
    ...
    return s17.length === 0 ? r11 : __spreadProps(__spreadValues({}, r11), { selectedIndex: u(T7, { [0]: () => t14.indexOf(s17[0]), [1]: () => t14.indexOf(s17[s17.length - 1]) }) });
  }
  ...
  return c10 === -1 && (c10 = e6.selectedIndex), __spreadProps(__spreadValues({}, r11), { selectedIndex: c10 });
}, [1](e6, n5) {
  var r11;
  ...
  return s17 === -1 && (s17 = e6.selectedIndex), __spreadProps(__spreadValues({}, e6), { tabs: o11, selectedIndex: s17 });
}, [2](e6, n5) {
  return __spreadProps(__spreadValues({}, e6), { tabs: e6.tabs.filter((t14) => t14 !== n5.tab) });
}, [3](e6, n5) {
  return e6.panels.includes(n5.panel) ? e6 : __spreadProps(__spreadValues({}, e6), { panels: A([...e6.panels, n5.panel], (t14) => t14.current) });
}, [4](e6, n5) {
  return __spreadProps(__spreadValues({}, e6), { panels: e6.panels.filter((t14) => t14 !== n5.panel) });
} };
...
function me4(e6, n5) {
  let _a = e6, { defaultIndex: t14 = 0, vertical: o11 = false, manual: s17 = false, onChange: r11, selectedIndex: i10 = null } = _a, R3 = __objRest(_a, ["defaultIndex", "vertical", "manual", "onChange", "selectedIndex"]);
  ...
  })), x6 = s2(l11.tabs), E7 = (0, import_react40.useMemo)(() => __spreadValues({ orientation: b6, activation: c10 }, l11), [b6, c10, l11]), S9 = o4((p9) => (d15({ type: 1, tab: p9 }), () => d15({ type: 2, tab: p9 }))), A6 = o4((p9) => (d15({ type: 3, panel: p9 }), () => d15({ type: 4, panel: p9 }))), L7 = o4((p9) => {
...
function xe7(e6, n5) {
  var p9, I7;
  let t14 = I(), _a = e6, { id: o11 = `headlessui-tabs-tab-${t14}` } = _a, s17 = __objRest(_a, ["id"]), { orientation: r11, activation: i10, selectedIndex: R3, tabs: b6, panels: c10 } = M7("Tab"), u8 = q4("Tab"), T7 = M7("Tab"), l11 = (0, import_react40.useRef)(null), d15 = y(l11, n5);
...
function De2(e6, n5) {
  var E7, S9, A6, L7;
  let t14 = I(), _a = e6, { id: o11 = `headlessui-tabs-panel-${t14}`, tabIndex: s17 = 0 } = _a, r11 = __objRest(_a, ["id", "tabIndex"]), { selectedIndex: i10, tabs: R3, panels: b6 } = M7("Tab.Panel"), c10 = q4("Tab.Panel"), u8 = (0, import_react40.useRef)(null), T7 = y(u8, n5);
  ...
  return !y5 && ((A6 = r11.unmount) == null || A6) && !((L7 = r11.static) != null && L7) ? import_react40.default.createElement(c2, __spreadValues({ as: "span" }, x6)) : D({ ourProps: x6, theirProps: r11, slot: m11, defaultTag: Re2, features: Le3, visible: y5, name: "Tabs.Panel" });
}
var Se3 = L3(xe7);
var Ie5 = L3(me4);
var Fe4 = L3(ge4);
...
function Ne5(n5, t14) {
  let _a = n5, { beforeEnter: r11, afterEnter: o11, beforeLeave: y5, afterLeave: N5, enter: p9, enterFrom: x6, enterTo: m11, entered: c10, leave: u8, leaveFrom: h10, leaveTo: v5 } = _a, s17 = __objRest(_a, ["beforeEnter", "afterEnter", "beforeLeave", "afterLeave", "enter", "enterFrom", "enterTo", "entered", "leave", "leaveFrom", "leaveTo"]), e6 = (0, import_react41.useRef)(null), a11 = y(e6, t14), i10 = s17.unmount ? w2.Unmount : w2.Hidden, { show: l11, appear: T7, initial: se5 } = be4(), [g6, M8] = (0, import_react41.useState)(l11 ? "visible" : "hidden"), z5 = Se4(), { register: F9, unregister: L7 } = z5, U5 = (0, import_react41.useRef)(null);
  ...
  return T7 && l11 && s.isServer && (B4 = __spreadProps(__spreadValues({}, B4), { className: e2(s17.className, ...j5.current.enter, ...j5.current.enterFrom) })), import_react41.default.createElement(I6.Provider, { value: O3 }, import_react41.default.createElement(c3, { value: u(g6, { ["visible"]: d4.Open, ["hidden"]: d4.Closed }) | H8.flags }, D({ ourProps: Te4, theirProps: B4, defaultTag: ye5, features: ie3, visible: g6 === "visible", name: "Transition.Child" })));
}
function He5(n5, t14) {
  let _a = n5, { show: r11, appear: o11 = false, unmount: y5 } = _a, N5 = __objRest(_a, ["show", "appear", "unmount"]), p9 = (0, import_react41.useRef)(null), x6 = y(p9, t14);
  l2();
  let m11 = C();
  ...
  let i10 = { unmount: y5 };
  return import_react41.default.createElement(I6.Provider, { value: h10 }, import_react41.default.createElement(A5.Provider, { value: a11 }, D({ ourProps: __spreadProps(__spreadValues({}, i10), { as: import_react41.Fragment, children: import_react41.default.createElement(oe3, __spreadValues(__spreadValues({ ref: x6 }, i10), N5)) }), theirProps: {}, defaultTag: import_react41.Fragment, features: ie3, visible: c10 === "visible", name: "Transition" })));
}
function De3(n5, t14) {
  let r11 = (0, import_react41.useContext)(A5) !== null, o11 = C() !== null;
  return import_react41.default.createElement(import_react41.default.Fragment, null, !r11 && o11 ? import_react41.default.createElement(q5, __spreadValues({ ref: t14 }, n5)) : import_react41.default.createElement(oe3, __spreadValues({ ref: t14 }, n5)));
}
var q5 = L3(He5);
var oe3 = L3(Ne5);
var Fe5 = L3(De3);
